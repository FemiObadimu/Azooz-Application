          ...
          <div className={enabled ? "blackBG" : "whiteBG"}>
            <>
              <div className="min-h-full">
                ...
                <div className="py-10">
                  <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex flex-row flex-wrap justify-center items-center">
                      <div
                        className={enabled ? "head-image2" : "head-image"}
                      ...
                      >
                        <h1 className="main-head text-3xl special text-center font-bold main-clr">
                          .. The Azooz ..
                        </h1>
                        <p className="py-4 text-center font-medium text-base ">
                        ...
                        <div className="flex justify-around flex-row">
                          <div>
                            <Link to="/about">
                              <button
                                type="button"
                                className="inline-flex items-center px-6 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white main-bg"
                              >
                                About
                              </button>
                            </Link>
                  ...
                  <section className="py-12" data-aos="zoom-in">
                    <div className="text-center">
                      <h1 className="text-4xl font-bold text-gray-500 py-8">
                        ...
                        innovate are design problems."
                      </h1>

                      <p className="py-4 font-bold text-2xl  main-clr">
                ...
                <section id="#works" className="py-8" data-aos="zoom-in">
                  <div className="text-gray-600 px-10 ">
                    ...
                    <div>
                      ...
                      multiple projects with a human <br /> centered approach
                      and empathy driven mindset. Projects range from a simple
                      redesign to a complete user experience revamp.
                    </div>
                  </div>
                </section>
                      ...
                      <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                        ...
                        <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                          ...
                          <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                            A product designer from Ilorin, Nigeria. with a
                            strong passion for design solutions in their
                            simplest and most usable form while serving both
